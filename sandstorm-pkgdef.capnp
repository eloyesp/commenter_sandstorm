...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "jew43f1efeykxnpthr189stvkznd2r0hppn2aw8du1a8q4mpwych",
...
const myCommand :Spk.Manifest.Command = (
  ...
  argv = ["/sandstorm-http-bridge", "3000", "--", ".gs/bin/thin", "start", "-p", "3000"],
  environ = [
    # Note that this defines the *entire* environment seen by your app.
    (key = "PATH", value = "/usr/local/bin:/usr/bin:/bin:/.gs/bin"),
    (key = "GEM_HOME", value = "/.gs"),
